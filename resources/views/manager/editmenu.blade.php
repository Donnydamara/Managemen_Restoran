            ...
            <div class="card-body">
                <form action="{{ route('updateMenu', ['id' => $menu->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            @if($menu->image)
                            <img id="old-image" src="{{ asset('img/menu/' . $menu->image) }}" alt="Gambar Menu" style="max-width: 20%; margin-bottom: 10px;">
                            @else
                            <p>Tidak ada gambar</p>
                            @endif
                            <img id="image-preview" src="#" alt="Preview" style="max-width: 20%; margin-bottom:10px; display: none; ">
                        </div>
