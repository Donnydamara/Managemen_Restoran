                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box bg-info">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">Rp. {{ number_format($totalProfits) }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-sm-9">
                    <div class="box bg-white">
                        @if (!empty($menuLaris) && !empty($secondMenuLaris))
                            <div id="chartMenuLaris" style="width: 88%; height: 220px;"></div>
                            <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
                ...
                <div class="col-12 col-sm-9">
                    <div class="box bg-white">
                        <div id="area_chart_div" style="width: 85%; height: 220px;"></div>
                        <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
                        <script>
                            google.charts.load('current', {
                                'packages': ['corechart']
