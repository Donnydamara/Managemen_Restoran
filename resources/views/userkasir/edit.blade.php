...
@section('content')
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form action="{{ route('userkasir.update', ['user' => $user->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        @error('role')
                            <span class="invalid-feedback" role="alert" style="background:yellow:color:'red'">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('userkasir.index') }}" class="btn btn-secondary btn-block">Cancel</a>
                        </div>
                        <div class="col-6">
