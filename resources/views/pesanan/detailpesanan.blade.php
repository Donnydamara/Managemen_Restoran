				...
				<div class="col-md-6 mx-auto d-flex justify-content-center">
					<div class="card mb-3">
						...
						<div class="col-md-12 text-center mt-3">
							<button onclick="cetak('printableArea')" class="btn btn-primary mr-3"><i class="fa fa-print"> </i> Cetak Struk</button>
							<a class="btn btn-danger" href=" {{ route('pesanan') }} "><i class="fa fa-plus"> </i> Order Baru</a>			
						</div>
					</div>
				</div>
			</div>
