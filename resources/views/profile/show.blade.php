...
<div class="container">
    <div class="row">
        <div class="col-md-4 img-container">
            ...
            <img src="{{ asset('image/profil/' . $user->photo_path) }}" alt="Profile Picture" class="img-fluid rounded-circle img-thumbnail foto-profile">
        </div>
        <div class="col-md-8 ">
...
<div class="modal fade" id="passwordValidationModal" tabindex="-1" role="dialog" aria-labelledby="passwordValidationModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="passwordValidationModalLabel">Validasi Password</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="passwordValidationForm" action="{{ route('profile.validate-password') }}" method="post" data-edit-profile-url="{{ route('profile.edit') }}">
                    @csrf
                    <div class="form-group">
                        <label for="validationPassword">Masukkan Password Anda:</label>
