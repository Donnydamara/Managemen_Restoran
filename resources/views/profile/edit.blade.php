        ...
        <div class="card-body">
            ...
            <form action="{{ route('profile.update', ['user' => $user->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div>
                        @if ($user->photo_path)
                            <img id="old-image" src="{{ asset('image/profil/' . $user->photo_path) }}" alt="Profile Photo"
                                style="max-width: 30%; margin-bottom: 10px;">
                        @else
                            <p>Tidak ada gambar</p>
                        @endif
                        <img id="image-preview" src="#" alt="Preview"
                            style="max-width: 30%; margin-bottom:10px; display: none; ">
                    </div>
