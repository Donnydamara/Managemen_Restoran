    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header text-left">
                <a href="{{ route('users.create') }}" class="btn btn-success px-4" role="button"><i class="fa-solid fa-plus"></i>
                    Tambah User
                </a>
            </div>
            <div class="card-body">
                <table class="table table-hover mb-0" id="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($user->photo_path)
                                <img src="{{ asset('image/profil/' . $user->photo_path) }}" alt="Profile Photo" class="rounded-circle" style="width: 200px; height: 200px; object-fit: cover;">
                                @else
                                No photo available
                                @endif
                            </td>
                            ...
                            <td style="width: 200px; text-align: center;">
                                ...
                                <!-- button edit -->
                                <a href="{{ route('users.edit', ['user' => $user->id]) }}" class="btn btn-warning mb-3 px-3">
                                ...
                                <!-- button hapus -->
                                <a onclick="confirmDelete(this)" data-url="{{ route('users.destroy', ['user' => $user->id]) }}" data-user-name="{{ $user->name }}" class="btn btn-danger mb-3 px-3">
                                    <i class="fa-solid fa-trash-can"></i>

                                </a>

                                <a href="{{ route('users.resetPassword', ['id' => $user->id]) }}" class="btn btn-info mb-3 px-3">
